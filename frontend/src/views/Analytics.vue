            ...
            <div class="card-container">
              <div class="row">
                ...
                <div class="card-wrapper">
                  <div class="card card-default card-size carding ">
                    <div class="card-header">
                      <h3  class="fa-solid fa-user-group">   Users</h3><br>
                    </div>
                    <div class="card-body">
                ...
                <div class="card-wrapper">
                  <div class="card card-default card-size carding ">
                    <div class="card-header">
                      <h2  class="fa-solid fa-bag-shopping">   E-Shop</h2><br>
                    </div>
                    <div class="card-body">
                      <div class="bg-primary d-flex justify-content-between flex-wrap p-4 text-white align-items-lg-end carding" style="height: 100%; width: 100%">
                        <div class="d-flex flex-column">
                ...
                <div class="card-wrapper" style="padding: 0;">
                  <div class="card card-default" id="user-acquisition" >
                    <div class="card-header border-bottom pb-0">
                      <h3  class="fa-solid fa-id-badge">  User Acquisition</h3><br>
                      <table class="table">
                        <thead>
                          <tr>
                            <th>User</th>
                ...
                <div class="card-wrapper">
                  <div class="card card-default">
                    <div class="card-header">
                      <h3  class="fa-solid fa-clipboard-list">  Orders Inventory</h3><br>
                    </div>
