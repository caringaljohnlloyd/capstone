<template>
  ...
  <div class="container-fluid">
    ...
    <section>
      ...
      <canvas ref="yearlyCanvas"></canvas>
    </section>
  </div> -->
                <div>
                  <section>
                    <h2>Sales Report</h2>
                    <button @click="printSalesReport">Print Sales Report</button>
                    <div>
                      <button @click="updateChart('daily')">Daily</button>
                      <button @click="updateChart('monthly')">Monthly</button>
                      <button @click="updateChart('yearly')">Yearly</button>
                    </div>
            ...
            <tr>
              <td class="col-xl-4">
                ...
                >
                  ...
                  <div class="card-body">
                    ...
                    <div v-else>
                      <div
                        class="bg-primary d-flex justify-content-between flex-wrap p-4 text-white align-items-lg-end"
              ...
              <td class="col-xl-4">
                ...
                >
                  ...
                  <div class="card-body">
                    <div
                      class="bg-success d-flex justify-content-between flex-wrap p-4 text-white align-items-lg-end"
                      style="height: 100%; width: 100%"
                    >
                      <div class="d-flex flex-column">
...
a.badge-info-dark:hover,
a.badge-info-dark:focus {
  color: #ffffff;
  background-color: #3371f8;
}
...
.offcanvas-overlay {
  ...
  -webkit-animation: k-animate-fade-in 0.3s linear 1;
...
.breadcrumb.breadcrumb-secondary .breadcrumb-item,
.breadcrumb.breadcrumb-secondary .breadcrumb-item a {
  color: #ffffff;
}
