                    ...
                    <div v-for="staff in staff" class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="rounded shadow overflow-hidden">
                            <div class="position-relative">
                                <img class="img-fluid menu" style="width: 150%; max-width: 300px; height: 330px;" :src="`https://eduardos-resort.online/backend/backend/public/uploads/${staff.staff_image}`" alt="">
